...
// Fix callouts
htmlContent = htmlContent.replace(/<blockquote>\s*<p>\[!NOTE\]<br>([\s\S]*?)<\/p>\s*<\/blockquote>/g, '<div class="callout-note"><strong>📝 Note</strong><br>$1</div>');
htmlContent = htmlContent.replace(/<blockquote>\s*<p>\[!IMPORTANT\]<br>([\s\S]*?)<\/p>\s*<\/blockquote>/g, '<div class="callout-important"><strong>🚨 Important</strong><br>$1</div>');
htmlContent = htmlContent.replace(/<blockquote>\s*<p>\[!TIP\]<br>([\s\S]*?)<\/p>\s*<\/blockquote>/g, '<div class="callout-tip"><strong>💡 Tip</strong><br>$1</div>');
...
htmlContent = htmlContent.replace(/`([A-Za-z\\/ ]+):` \\[(████████████████████)\\] ([0-9\\+]+)/g, 
...
htmlContent = htmlContent.replace('<div align="center">', '<div class="hero-section"><div class="hero-icon">S</div>');
...
<body>
    ...
    <script>
        mermaid.initialize({ startOnLoad: true, theme: 'neutral', fontFamily: 'Inter' });
    </script>
</body>
</html>`;

fs.writeFileSync(outputPath, htmlTemplate);
console.log('Static HTML Report generated successfully at ' + outputPath);
