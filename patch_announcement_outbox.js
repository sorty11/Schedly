...
const newCode = `import 'package:cloud_firestore/cloud_firestore.dart';
...
class AnnouncementService {
  ...
  static Future<void> createAnnouncement({
    ...
    // 3. Ping backend to wake up worker
    NotificationApiClient.wakeUpWorker();
  }
}
`;

fs.writeFileSync('lib/services/announcement_service.dart', newCode);
