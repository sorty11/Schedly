...
class CRAuthBottomSheet extends StatefulWidget {
  ...
  const CRAuthBottomSheet({super.key, this.initialYear, this.initialDivision});
  ...
  Future<void> _authenticate() async {
    ...
    try {
      ...
      if (_sectionExists) {
        ...
        debugPrint(
          'CR_VERIFY: Password verified locally. Updating Firestore role...',
        );
