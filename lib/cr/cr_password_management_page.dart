...
class CRPasswordManagementPage extends StatefulWidget {
  ...
  @override
  State<CRPasswordManagementPage> createState() =>
      _CRPasswordManagementPageState();
}
      ...
      if (doc.exists) {
        ...
        setState(() {
          ...
          if (data['passwordLastUpdatedAt'] != null) {
            _lastUpdatedAt = (data['passwordLastUpdatedAt'] as Timestamp)
                .toDate();
          }
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Icon(
                role == 'CR' ? Icons.security_rounded : Icons.key_rounded,
          ...
          SizedBox(
            ...
            child: AnimatedButton(
              onPressed: _isLoading || password == null
                  ? null
                  : () => _showChangePasswordSheet(role),
  ...
  Future<void> _handleSave() async {
    ...
    try {
      ...
      await FirebaseFirestore.instance
          ...
          .update({
            ...
            'passwordLastUpdatedBy':
                '${AppSettings.studentName} (${AppSettings.studentRollNo})',
          });

      if (!mounted) return;
      AppDialogs.showSnackBar(
        context: context,
        message: '${widget.role} password updated successfully.',
      );
      widget.onSuccess();
      ...
      AppDialogs.showError(
        context: context,
        title: 'Error',
        message: 'Failed to update password. Please check your connection.',
      );
    } finally {
              ...
              child: Column(
                ...
                children: [
                  ...
                  TextFormField(
                    ...
                    validator: (val) {
                      if (val == null || val.trim().isEmpty) return 'Required';
                      if (val.trim() != _newPwdController.text.trim())
