...
void main() {
  test('Deep PDF Analysis', () async {
    ...
    final firstPageLines = extractor.extractTextLines(
      startPageIndex: 0,
      endPageIndex: 0,
    );
    ...
    if (document.pages.count > 1) {
      ...
      final middlePageLines = extractor.extractTextLines(
        startPageIndex: middlePage,
        endPageIndex: middlePage,
      );
    ...
    final lastPageLines = extractor.extractTextLines(
      startPageIndex: lastPageIdx,
      endPageIndex: lastPageIdx,
    );
